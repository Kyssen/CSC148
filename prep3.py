...
class Employee:
    ...
    === Private attributes ===
    _total_pay: This is the total amount the employee has been paid
    """
    id_: int
    name: str
    _total_pay: float
    ...
    def pay(self, pay_date: date) -> None:
        """Pay this Employee on the given date and record the payment and update
        _total payment.
